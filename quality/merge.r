...
plotMerge = function(n, yaxt = 's') {
  ...
  legend(0.5, -1700, expression("Direct "(delta==100), "Stratified merge "(delta==200,100), "Flat merge "(delta==100,100)), fill = c(rgb(0.95, 0.95, 0.95), rgb(0.7, 0.7, 0.7), rgb(0.4, 0.4, 0.4)), cex=0.7)

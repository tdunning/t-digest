...
\SetKwFor{For}{for}{\string:}{}
 \label{alg:merge}
\SetNoFillComment
\KwIn{Sequence $C = [c_1 \ldots c_m]$ of real-valued, weighted centroids with components $\mathtt{sum}$ and $\mathtt{count}$ arranged in ascending order by mean, data buffer  $X = { x_1,\ldots x_n}$ of real-valued, weighted points, and compression factor $\delta$}
\KwOut{New ordered set $C'=[c'_1 \ldots c'_m]$ of weighted centroids} 

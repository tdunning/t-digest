n = 10
fade = 'darkgray'
pdf("k-q-plot.pdf", width=2.5, height=2.2, pointsize=8, family='serif')
...
title(xlab=expression(italic(q)), line=1.3, cex.lab=1.5)
axis(side=2, at=seq(-5,5,by=1), mgp=c(1,0.6,0))
title(ylab=expression(italic(k)), line=1.5, cex.lab=1.5)
